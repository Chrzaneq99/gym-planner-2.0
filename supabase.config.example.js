// Copy this file to `supabase.config.js` and replace the placeholder values with your Supabase project's values.
// Do NOT commit `supabase.config.js` to version control — keep it local and secret.
